  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex flex-col">
      ...
      <nav className="w-full px-6 py-4 flex items-center justify-between border-b border-white/10">
        ...
        >
          ¿No tenés cuenta? <span className="text-blue-400 font-medium">Empezá gratis</span>
        </Link>
      </nav>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    disabled={isLoading}
                    className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition disabled:opacity-50 disabled:cursor-not-allowed"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      disabled={isLoading}
                      className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 pr-11 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition disabled:opacity-50 disabled:cursor-not-allowed"
                    />
                    <button
                      type="button"
